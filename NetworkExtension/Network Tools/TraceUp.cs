...
{
    public class TraceUp : ESRI.ArcGIS.Desktop.AddIns.Button
    {
        public TraceUp()
        {
        }
        ...
        protected override void OnClick()
        {
            ...
            if (feat != null)
            {
                ...
                {
                    List<FuturaNetwork.INetworkObject> lst = ExtensionInfo.netUtil.UpStream(guid, (feat.ShapeCopy.GeometryType == esriGeometryType.esriGeometryPoint) ? 0 : 1, -1, "");
