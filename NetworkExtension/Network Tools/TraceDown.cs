...
{
    public class TraceDown : ESRI.ArcGIS.Desktop.AddIns.Button
    {
        public TraceDown()
        {
        }
        ...
        protected override void OnClick()
        {
            ...
            if (feat != null)
            {
                ...
                {
                    List<FuturaNetwork.INetworkObject> lst = ExtensionInfo.netUtil.DownStream(guid,(feat.ShapeCopy.GeometryType == esriGeometryType.esriGeometryPoint) ? 0:1  , -1, "");
