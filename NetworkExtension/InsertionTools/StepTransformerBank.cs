...
{
    public class StepTransformerBank : InsertionTool, IStepTransformerBankClass
    {
        public StepTransformerBank()
        {
            base.Associated_FeatureClassName = "StepTransformerBank";
        }
